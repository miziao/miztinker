...
public class ToolDefinitions {
    ...
    public static final ToolDefinition TINKER_LOLI_PICKAXE_TD = ToolDefinition.create(MiztinkerTools.tinker_loli_pickaxe);
    public static final ToolDefinition OLD_SWORD_TD = ToolDefinition.create(MiztinkerTools.old_sword);
