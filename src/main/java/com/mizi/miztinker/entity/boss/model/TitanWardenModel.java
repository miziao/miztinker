...
public class TitanWardenModel extends GeoModel<TitanWarden> {
    private final ResourceLocation model = new ResourceLocation(miztinker.MODID, "geo/titan_warden.geo.json");
    private final ResourceLocation texture = new ResourceLocation(miztinker.MODID, "textures/entity/titan_warden.png");
    private final ResourceLocation animations = new ResourceLocation(miztinker.MODID, "animations/titan_warden.animation.json");
